...
/// <summary>
/// ガードゲージ増減管理クラス
/// <para>　戦況に応じてガードを増減させる。</para>
/// <para>　アタッチGO：Canvas_GuardGage->Parent</para>
/// </summary>
public class GuardGage : MonoBehaviour
{
    /// <summary>
    /// 1P側のゲージスプライト
    /// </summary>
    ...
    /// </summary>
    private Vector3 barScale1P = new Vector3(0.5f, 1.7f, 1.2f);
    /// <summary>
    /// 2P側ゲージImageコンポのローカルスケール
    /// </summary>
    private Vector3 barScale2P = new Vector3(0.5f, 1.7f, 1.2f);
