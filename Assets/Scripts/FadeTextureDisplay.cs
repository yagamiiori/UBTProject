...
public class FadeTextureDisplay : MonoBehaviour
{
    ...
    /// <summary>アルファ値（到達値：255）</summary>
    [SerializeField]
    private Color reachingAlphaVal = new Color(1f, 1f, 1f, 255f);
    ...
    void Awake()
    {
        if (isDontDestroy)
        {
            ...
            if (1 < GameObject.FindGameObjectsWithTag("Canvas_FadeDisplay").Length)
            {
